...
type VerifyIconProps = {} & JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>;

const VerifyIcon: React.FC<VerifyIconProps> = (props: VerifyIconProps) => {
    return (
        <svg
            width="8"
            height="8"
        ...
        >
            <g clip-path="url(#clip0_6874_60)">
                <path
                    ...
                    fill="url(#paint0_linear_6874_60)"
                />
                <path
